<article class="flex bg-gray-100 p-6 border border-gray-200 rounded-xl space-x-4">
    ...
    <div>
        ...
        <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. A molestiae laborum iure, ut iusto, laudantium amet vel harum maxime quis ad necessitatibus aperiam! Ut error ipsa sed labore blanditiis quia!
        </p>
    </div>
</article>